...
<body>
	...
	<table align="center" class="nqLink">
		<tr height="50">
			<th width="45%" id="right">공지사항</th>
			<th width="10%"></th>
			<th width="45%"><a
				href="campMain.jsp?id=<%=id%>&center=./nq/question.jsp?id=<%=id%>&op=q">
					자주하는 질문 </a></th>
		</tr>
	</table>
	<br>
	...
	<table align="center" width="1000" height="700">
		<tr height="600">
			<td align="center">
				<div class="card align-middle" style="width: 1100px; height: 600px;">
					...
					<div class="card-body">
						<form action="campMain.jsp" method="post">
							...
							<table border="1" class="nqTable table-bordered table-hover">
								...
								<tr>
									<td colspan="5">
										<div id="myContent<%=i%>" style="display: none; height: 100px;">
											<br>
											<%=bean.getContent()%>
											<%
												if (id.equals("admin")) {
